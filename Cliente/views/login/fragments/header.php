            ...
            <ul class="email">
               ...
               <li>
                  ...
                  if (isset($_SESSION['usuario_logueado'])) {
                     ...
                     echo '<a href="login.php"><i class="fas fa-user-circle fa-lg"></i></a>';
                  }
                  ?>
               </li>
            </ul>
   ...
   <div class="modal-dialog">
      <div class="modal-content" style="background-color: #F7F4ED;">
         ...
         <div class="modal-footer" style="justify-content: space-between;">
            <button type="button" class="btn btn-editar-modal">Editar</button>
            <button type="button" class="btn btn-citas-modal"> Citas Y Facturas</button>
         </div>
      </div>
   </div>
</div>
